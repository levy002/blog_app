...
RSpec.describe 'Posts show page', type: :feature do
  before(:each) do
    User.destroy_all
    @user = User.create(name: 'Levy', photo: 'profile.png', bio: 'Developer', posts_counter: 0)
    @user1 = User.create(name: 'Kayline', photo: 'profile.jpg', bio: 'Developer', posts_counter: 0)
